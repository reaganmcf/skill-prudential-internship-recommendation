...
const NoHandler = {
  canHandle(handlerInput) {
    const sessionAttributes = handlerInput.attributesManager.getSessionAttributes();
    let inTraverseScanLoop = handlerInput.requestEnvelope.session.attributes.inTraverseScanLoop ? handlerInput.requestEnvelope.session.attributes.inTraverseScanLoop : false;
    return (handlerInput.requestEnvelope.request.type === "IntentRequest"
      && handlerInput.requestEnvelope.request.intent.name === "AMAZON.NoIntent"
      && inTraverseScanLoop == true)
  },
  handle(handlerInput) {
    sessionAttributes.speakOutput = 'Goodbye!'
    sessionAttributes.repromptSpeech = undefined;
...
const ScanIntentHandler = {
  canHandle(handlerInput) {
    ...
    let tempOverrideBool = handlerInput.requestEnvelope.session.attributes.checkYesForSearchOverride ? handlerInput.requestEnvelope.session.attributes.checkYesForSearchOverride : false;
    let inTraverseScanLoop = handlerInput.requestEnvelope.session.attributes.inTraverseScanLoop ? handlerInput.requestEnvelope.session.attributes.inTraverseScanLoop : false;
    sessionAttributes.checkYesForSearchOverride = false;
    console.log("are we in traverse scan? : " + inTraverseScanLoop)
    return handlerInput.requestEnvelope.request.type === "IntentRequest"
      && ((handlerInput.requestEnvelope.request.intent.name === "AMAZON.YesIntent"
        && (tempOverrideBool == true || inTraverseScanLoop == true))
  ...
  handle(handlerInput) {
    ...
    const sessionAttributes = handlerInput.attributesManager.getSessionAttributes();
    let inTraverseScanLoop = handlerInput.requestEnvelope.session.attributes.inTraverseScanLoop ? handlerInput.requestEnvelope.session.attributes.inTraverseScanLoop : false;
    let perfectMatchStored = handlerInput.requestEnvelope.session.attributes.perfectMatch ? handlerInput.requestEnvelope.session.attributes.perfectMatch : [];
    //perform scan
    if (inTraverseScanLoop == true) {
      let job = perfectMatchStored.splice(0, 1)[0];
      console.log("matches stored:")
      console.log(perfectMatchStored);
      console.log("job popped:");
      console.log(job)
      sessionAttributes.speakOutput = job.job_description;
      sessionAttributes.repromptSpeech = "would you like to hear the next?"
      sessionAttributes.perfectMatch = perfectMatchStored;
      sessionAttributes.inTraverseScanLoop = true;
      if (perfectMatchStored.length != 0) {
        return handlerInput.responseBuilder.speak(sessionAttributes.speakOutput + ". Would you ike to hear the next?").reprompt(sessionAttributes.repromptSpeech).getResponse();
      } else {
        return handlerInput.responseBuilder.speak(sessionAttributes.speakOutput + ". Make sure to check them out!").getResponse();
      }
    } else {
      ...
      let speechOutput = perfectMatch.length > 0 ? `There are ${perfectMatch.length} matches, would you like to hear them?` : "there are no matches";

      sessionAttributes.speakOutput = speechOutput;
      sessionAttributes.repromptSpeech = requestAttributes.t('would you like to hear them?');
      sessionAttributes.inTraverseScanLoop = true;
      sessionAttributes.perfectMatch = perfectMatch;
      ...
      if (perfectMatch.length > 0) {
        ...
        sessionAttributes.speakOutput = "Sorry, there are no matches. Ask update my profile to recalibrate your settings";
        sessionAttributes.repromptSpeech = "Ask update my profile to recalibrate your settings"
        sessionAttributes.inTraverseScanLoop = false;
        sessionAttributes.perfectMatch = undefined;
        return handlerInput.responseBuilder.speak(sessionAttributes.speakOutput).reprompt(sessionAttributes.repromptSpeech).getResponse()
      }
    }
  }
}
...
let jobs = [
  {
    "category": "OPERATIONS",
    "job_code": "TA 0001Y",
    "job_title": "Investment Operations Internship",
    "job_type": "INTERNSHIP",
    "job_description": "Are you looking for a career that helps you apply your love of data, financial analysis, and investments to facilitate business strategy and work with diverse teams on challenging projects? If you are results driven, have a real passion for working with financial data, are deeply analytical and highly creative, then Prudential’s Investment Operations Internship Program is the place for you! Prudential Investment Operations and Systems provides the operations and technology support that contributes to Prudential being a world-class investment manager.",
    "location_city": [
      "NEWARK"
    ],
    "location_state": [
  ...
  },
  {
    "category": "TECHNOLOGY",
    "job_code": "TA 0001V",
    "job_title": "Coding/Programming Internship",
    "job_type": "INTERNSHIP",
    "job_description": "Do you aspire to be a world-class programmer? Do you enjoy solving complex challenges and creating unique solutions through your code? As an organization that focuses on both technology and professional development, we encourage aspiring and talented programmers to apply their unique programming skills in our Coding and Software Development Internship. You will collaborate with your peers and our DevOps team in our ongoing efforts to invest in new platforms and capabilities. This internship will challenge you to influence technical direction, develop and review detailed implementation designs, and be accountable for the stability and extendibility of your applications. If you want to apply your knowledge and skills towards an impactful, insightful, and meaningful internship experience, then this is the role for you!",
    "location_city": [
      "NEWARK",
      "SHELTON",
      "ROSELAND",
  ...
  },
  {
    "category": "TECHNOLOGY",
    "job_code": "TA 0001U",
    "job_title": "Data Analytics and Business Systems Internship",
    "job_type": "INTERNSHIP",
    "job_description": "Are you a freshman, sophomore, or junior looking to put your data analytics skills to use in a business setting? Do you want to work with experienced professionals and subject matter experts to help you develop your technical skillset? If this sounds like you, that’s a challenge we can help you meet as a member of our Data Analytics Internship Program. We are looking for top-performing students who excel at analytical problem solving. As a Data Analyst, you will improve business initiatives through operational enhancement while aligning our technical capabilities towards efficient and strategic business solutions. Come join us for an insightful and personalized summer internship experience.",
    "location_city": [
      "NEWARK",
      "SHELTON",
      "ROSELAND",
  ...
  },
  {
    "category": "TECHNOLOGY",
    "job_code": "TA 0001X",
    "job_title": "Product Managment Internship",
    "job_type": "INTERNSHIP",
    "job_description": "Are you a highly organized and ambitious student who wants to put your technical and product management skills to use in a business environment? If you have a passion for Product Management, want to learn and communicate new ideas to a professional audience, and drive challenging projects end-to-end, then this is the internship for you! Our Product Management Program invites financial technology, design, and technical enthusiasts to help build, optimize and deliver platforms for Prudential Financials’ global businesses. Your creativity helps build the world in which we operate, conduct business, and serve our clients across the globe.",
    "location_city": [
      "SUNNYVALE",
      "NEWARK"
    ],
  ...
  },
  {
    "category": "TECHNOLOGY",
    "job_code": "TA 00020",
    "job_title": "Coding/Programming Associate",
    "job_type": "FULL_TIME",
    "job_description": "Do you aspire to be a world-class programmer? Do you enjoy solving complex challenges and creating unique solutions through your code? As an organization that focuses on both technology and professional development, we encourage aspiring and talented programmers to apply their unique programming skills in our Coding and Software Development Associate Program. This position will challenge you to influence technical direction, develop and review detailed implementation designs, and be accountable for the stability and extendibility of your applications.If you want to apply your knowledge and skills towards an impactful, insightful, and meaningful experience, then this is the role for you!",
    "location_city": [
      "NEWARK"
    ],
    "location_state": [
  ...
  },
  {
    "category": "TECHNOLOGY",
    "job_code": "TA 00022",
    "job_title": "Infrastructure Systems Development (Mainframe) Internship Program",
    "job_type": "INTERNSHIP",
    "job_description": "Are you looking to gain foundational technical Mainframe knowledge to apply in a professional environment, while developing strong relationships through training, mentorship, and ongoing feedback? If you have strong analytical skills, are eager to learn, and able to troubleshoot to resolve complex issues utilizing outside-the-box thinking and unique perspectives, then this Mainframe focused role is for you! Our technology internships will leverage the knowledge, skills and abilities that you have obtained through your academic studies to help solve some of our biggest challenges on the Mainframe platform. As an Infrastructure Systems Development Intern, you will work closely with senior developers, managers and mentors.",
    "location_city": [
      "NEWARK"
    ],
    "location_state": [
  ...
  },
  {
    "category": "SALES",
    "job_code": "ISG0003D",
    "job_title": "Individual Life Insurance Service Experience Internship",
    "job_type": "INTERNSHIP",
    "job_description": "Do you have the drive to achieve above and beyond expectations and a passion to help people? Are you highly motivated, analytical, and looking to thrive in a fast-paced environment? If you have the desire and vision to think creatively and are results driven, then the Service Experience internship on the Individual Life Insurance team is for you!",
    "location_city": [
      "JACKSONVILLE"
    ],
    "location_state": [
  ...
  },
  {
    "category": "SALES",
    "job_code": "NSD000AP",
    "job_title": "Individual Solutions Group Sales Internship",
    "job_type": "INTERNSHIP",
    "job_description": "Are you looking for a career that utilizes your ability to solve for complex challenges, uncover opportunities to drive value and work with diverse teams on challenging projects?  If you are an innovative, entrepreneurial thinker, looking to expand your financial knowledge and have a passion for closing business deals than a Sales Internship as part of the Individuals Solutions Group is for you! Individual Solutions provides financial advice and develops, distributes and services annuities, life insurance and other outcome-oriented solutions for consumers.",
    "location_city": [
      "PLYMOUTH",
      "DRESHER",
      "SHELTON"
  ...
  },
  {
    "category": "ACTUARIAL",
    "job_code": "ACT000RC",
    "job_title": "Actuarial Success Awareness Program",
    "job_type": "EXTERNSHIP",
    "job_description": "Are you a freshman or sophomore student majoring in actuarial science, mathematics, or statistics looking to diversify your skillset, learn more about the insurance and financial services industry, and open several career doors along the way? Then Prudential’s Actuarial Success Awareness Program  is the place for you! The Actuarial Success Awareness Program is a 1-week experience that is designed to expose strong mathematics students to a career in the Actuarial profession.",
    "location_city": [
      "NEWARK"
    ],
    "location_state": [
    ...
    "impact": "Are you a freshman or sophomore student majoring in actuarial science, mathematics, or statistics looking to diversify your skillset, learn more about the insurance and financial services industry, and open several career doors along the way? Are you interested in being a part of an exciting development program that is focused on professional skills training, working with diverse teams on exciting projects, and building relationships with leaders in the actuarial community? Then Prudential’s Actuarial Success Awareness Program (ASAP) is the place for you! The Actuarial Success Awareness Program (ASAP) is a 1-week experience that takes place in May 2020 and is designed to expose strong mathematics students to a career in the Actuarial profession. The program is open to freshmen and sophomore students from all backgrounds.",
    "qualifications": {
      "target_grad_year": [
        2021,
        2022,
  ...
  },
  {
    ...
    "job_code": "INV000F6",
    "job_title": "Strategic Investment Research Internship Program",
    "job_type": "INTERNSHIP",
    "job_description": "Are you looking for a career that helps you apply your love of finance, research, and asset management to strengthen business strategy and work with diverse teams on challenging projects? If you are results driven, have a real passion for working with data, and are a strong communicator and highly creative, then Prudential Investments is the place for you! The Strategic Investment Research Group within Prudential Investments, is a group of highly trained experts, and specialized analysts who devote their full attention to knowing and understanding the players in the global money management community.",
    "location_city": [
      "NEWARK"
    ],
    "location_state": [
  ...
  },
  {
    "category": "ASSET_MANAGEMENT",
    "job_code": "PCG0007K",
    "job_title": "Summer Investment Analyst: Prudential Private Capital",
    "job_type": "INTERNSHIP",
    "job_description": "Are you a rising junior looking to apply your analytical knowledge and make an impact within a dynamic, evolving organization? As a Summer Analyst, you would work on a small deal team responsible for underwriting, portfolio monitoring and marketing and contribute analytical and written content as part of the investment process over your 10-week summer internship.",
    "location_city": [
      "CHICACO",
      "LOS ANGELES",
      "ATLANTA",
  ...
  },
  {
    "category": "ASSET_MANAGEMENT",
    "job_code": "PCG0007N",
    "job_title": "Investment Analyst: Prudential Private Capital",
    "job_type": "FULL_TIME",
    "job_description": "Are you a rising senior looking to apply your analytical knowledge and make an impact within a dynamic, evolving organization? As an Investment Analyst, you would work on a small deal team responsible for underwriting, portfolio monitoring and marketing, while getting the chance to develop your analytical skills and learn to think like a buy-and-hold investor in a three-year analyst program. You will learn about investing private placements of senior debt and junior capital within a variety of industries from large, multi-national companies to smaller, privately-held companies.",
    "location_city": [
      "CHICACO",
      "LOS ANGELES",
      "ATLANTA",
  ...
  },
  {
    ...
    "job_type": "FULL_TIME",
    "job_description": "Are you looking for a career that helps you apply your love of data, financial analysis, and investments to facilitate business strategy and work with diverse teams on challenging projects? If you are results driven, motivated, have a real passion for working with financial data, are deeply analytical and highly creative, then Prudential’s Investment Operations Associate role is the position for you! Prudential Investment Operations and Systems provides the operations and technology support that contributes to Prudential being a world-class investment manager.",
    "location_city": [
      "NEWARK"
    ],
    "location_state": [
  ...
  },
  {
    "category": "OPERATIONS",
    "job_code": "GRO000CB",
    "job_title": "Workplace Solutions Group - Group Insurance Health and Productivity Internship",
    "job_type": "INTERNSHIP",
    "job_description": "Are you looking for a career that helps you apply your energy, curiosity and initiative to help solve some of Prudential’s business challenges? If you are an innovative, self-starter looking to continuously improve things and creatively solve problems, then a Health and Productivity Internship within the Workplace Solutions Group is for you.",
    "location_city": [
      "PORTLAND"
    ],
    "location_state": [
  ...
  },
  {
    ...
    "job_code": "TA 0001T",
    "job_title": "Project Management and Business Solutions Internship",
    "job_type": "INTERNSHIP",
    "job_description": "Do you aspire to be a Project Manager or Business Solutions Specialist? Do you enjoy solving problems? We are looking for aspiring Project Managers to help solve some of Prudential’s biggest challenges by aligning our technical initiatives towards efficient and strategic business solutions. In this role, your creativity in developing solutions to complex problems will be an asset that every business unit can leverage. If you want to help solve some of Prudential’s biggest challenges by aligning our technical initiatives towards efficient and strategic business solutions, then this is the role for you!",
    "location_city": [
      "NEWARK",
      "ROSELAND"
    ],
  ...
  },
  {
    "category": "SALES",
    "job_code": "CO 00042",
    "job_title": "Customer Office BYCP Sales and Service Internship",
    "job_type": "INTERNSHIP",
    "job_description": "Do you have the drive to achieve above and beyond expectations and a passion to help people? Are you highly motivated, analytical, and looking to thrive in a fast-paced environment? If you have the desire and vision to think creatively and are results driven, then the Customer Office Internship is for you! The Prudential Customer Office team’s mission is to deliver needs-based, human-centric experiences across all customer touch points at Prudential.",
    "location_city": [
      "PLYMOUTH"
    ],
    "location_state": [
  ...
  },
  {
    "category": "MARKETING",
    "job_code": "PGI0009T",
    "job_title": "Executive Marketing Summer Analyst",
    "job_type": "INTERNSHIP",
    "job_description": "We are currently looking for a rising sophomore or junior to join our team as a Summer Intern. As an intern, you will be part of a small, marketing team overseen by the Chief Administrative Officer of Prudential. You will be given high levels of responsibility and asked to engage in complex business/marketing challenges from day one. These projects will provide you with exposure to PGIM and the asset management industry, and you will begin to develop a broad business marketing toolkit.",
    "location_city": [
      "NEWARK"
    ],
    "location_state": [
